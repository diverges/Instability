...
public class LevelTwoB extends LevelLoader {
    ...
    private MessagePopupEntity neutronScript;
    private MessagePopupEntity jumperScript;
    private MessagePopupEntity dangerScript;
    ...
    public LevelTwoB(GameCanvas game) {
        ...
        neutronScript = new MessagePopupEntity(game, 40, "It appears that a supercharged-n" + "particle has made its way-n" + "through this section of the-n" + "asteroid. There exists the-n" + "possibility that it was-n" + "pulled in by the Radonite.", null);

        jumperScript = new MessagePopupEntity(game, 40, "Miners previously used these-n" + "jumpers to transfer vast amounts-n" + "of material from one region to-n" + "another. We may be able to use-n" + "them to our advantage.", null);

        dangerScript = new MessagePopupEntity(game, 40, "Malfunctioning droids detected.", null);

        endScript = new MessagePopupEntity(game, 40, "It appears that the particle-n" + "has been trapped within the-n" + "nearby ore. We have insufficient-n" + "information to track down its-n" + "previous destination. ", null);
