...
public class MenuMain extends Menu {
    ...
    public MenuMain(GameCanvas game) {
        ...
        levelTextureObjects.add(new ButtonEntity(game, "start", "menumain", "start-button-idle.png;start-button-clicked.png", null, CosmosConstants.WIDTH - 300, margin + 120, 200, 100));
		/*
		 * levelTextureObjects.add(new EntityButton(game, "options", null, null, CosmosConstants.WIDTH / 2 - 50, margin * 2 + 100, 100, 100, "Options"));
		 */

        levelTextureObjects.add(new ButtonEntity(game, "quit", "menumain", "quit-button-idle.png;quit-button-clicked.png", null, CosmosConstants.WIDTH - 300, margin * 2 + 170, 200, 100));
