...
public class ButtonEntity extends CosmosEntity {
	 ...
	 * @param height
	 */
	public ButtonEntity(GameCanvas game, String buttonRef, String folder,
			String ref, String onDeath, int x_pos, int y_pos, int width,
			int height) {
	...
	public void draw(Graphics g) {
		Color c = g.getColor();
		if (this.sprites != null) this.sprites[getCurrent()].draw(g,
			(int) me.x, (int) me.y);
		else {
			if (getCurrent() == 0) {
				g.setColor(Color.LIGHT_GRAY);
				g.fill3DRect((int) me.x, (int) me.y, (int) me.width,
					(int) me.height, true);
				g.setColor(Color.BLACK);
				g.drawString(msg, (int) me.x + 10,
					(int) (me.y + me.height / 2 + 3));
				g.setColor(c);
			} else {
				g.setColor(Color.LIGHT_GRAY);
				g.fill3DRect((int) me.x, (int) me.y, (int) me.width,
