...
public class BetaLevel extends LevelLoader {
	...
	MessageEntity script1, script2, script3;

	public BetaLevel(GameCanvas game) {
		super(game);

		// load level
		level = "wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww\n"
		...
		// load text
		script1 = new MessageEntity(game, null, null, null,
			CosmosConstants.WIDTH / 2 - 250, 75, -1, -1, 50,
			"TRAINING ZONE - Platform 9");

		script2 = new MessageEntity(game, null, null, null,
			CosmosConstants.WIDTH / 2 + 150, CosmosConstants.HEIGHT / 2 + 100,
			-1, -1, 50, game.getObjective()); // grab objective from main class
