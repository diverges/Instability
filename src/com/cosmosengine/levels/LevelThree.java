...
public class LevelThree extends LevelLoader {
	...
	MessagePopupEntity startScript, endScript;
	...
	public LevelThree(GameCanvas game) {
		...
		startScript = new MessagePopupEntity(game, 50,
			"Warning! Warning! Vast-n" + "amount of radiation detected-n"
					+ "nearby, presence of Radonite-n" + "confirmed.", null);

		endScript = new MessagePopupEntity(game, 50, "There is no mistake,-n"
				+ "we have located the Radonite.-n"
				+ "Great work BK201, your creator,-n"
				+ " AgentK, will be most pleased-n"
				+ "with your success. Now collect-n"
				+ "the substance and begin your-n"
				+ "voyage back to Earth.-n-n" + "N.E.L. Signing Off.", null);
