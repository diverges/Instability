...
public abstract class LevelLoader implements Loadable, Cloneable {
	...
	protected void loadLevel(String complex) {
		...
		while (scan.hasNext()) {
			...
			if (CosmosConstants.debug) System.out.println(row);
	...
	// individual
	// block
	private void loadRow(String[] complexBlocks, String row, int x_pos,
			int y_pos) {
		x_pos = 0; // reset x
		// String param = "";
		...
		for (int i = 0; i < row.length(); i++) {
			...
			if (CosmosConstants.debug) System.out.println(x_pos);

			if (block != '#') loadBlock(block, x_pos, y_pos); // load block
			// else
	...
	private void loadBlock(char block, int x_pos, int y_pos) {
		...
		switch (block) {
			case 'w':
				this.levelTextureObjects.add(new WallEntity(game, null,
					"cosmos_block_wall.png", null, x_pos, y_pos, 40, 40, -1));
				break;
			case 'd':
				this.levelTextureObjects
					.add(new BlockEntity(
						game,
						"dirt_sprites",
						"dirt-break1.png;dirt-break8.png;dirt-break7.png;dirt-break6.png;dirt-break5.png;dirt-break4.png;dirt-break3.png;dirt-break2.png",
						"dirt-get1.png;dirt-get2.png;dirt-get3.png;dirt-get4.png;dirt-get5.png;dirt-get6.png",
						x_pos, y_pos, 40, 40, null, 40, false));
				break;
			case 'H':
				this.levelTextureObjects
					.add(new BlockEntity(
						game,
						"hydrogen_sprites",
						"hydrogen-break1.png;dirt-break8.png;dirt-break7.png;dirt-break6.png;dirt-break5.png;dirt-break4.png;dirt-break3.png;dirt-break2.png",
						"dirt-get1.png;dirt-get2.png;dirt-get3.png;dirt-get4.png;dirt-get5.png;dirt-get6.png",
						x_pos, y_pos, 40, 40, CosmosConstants.HYDROGEN, 50,
						true));
				break;
			...
			case 'C':
				this.levelTextureObjects
					.add(new BlockEntity(
						game,
						"carbon_sprites",
						"carbon-break1.png;carbon-break8.png;carbon-break7.png;carbon-break6.png;carbon-break5.png;carbon-break4.png;carbon-break3.png;carbon-break2.png",
						"carbon-get1.png;carbon-get2.png;carbon-get3.png;carbon-get4.png;carbon-get5.png;carbon-get6.png",
						x_pos, y_pos, 40, 40, CosmosConstants.CARBON, 40, true));
				break;
			case 'U':
				this.levelTextureObjects
					.add(new BlockAnim(
						game,
						"uranium_sprites",
						"constant/Uranium1.png;Uranium-break7.png;Uranium-break6.png;Uranium-break5.png;Uranium-break4.png;Uranium-break3.png;Uranium-break2.png",
						"Uranium-get1.png;Uranium-get2.png;Uranium-get3.png;Uranium-get4.png;Uranium-get5.png;Uranium-get6.png",
						"Uranium1.png;Uranium2.png;Uranium3.png;Uranium4.png",
						x_pos, y_pos, 40, 40, 40, true, CosmosConstants.URANIUM));
				break;
			case 'E':
				this.levelTextureObjects
					.add(new BlockAnim(
						...
						"Uranium-get1.png;Uranium-get2.png;Uranium-get3.png;Uranium-get4.png;Uranium-get5.png;Uranium-get6.png",
						"Uranium1.png;Uranium2.png;Uranium3.png;Uranium4.png",
						x_pos, y_pos, 40, 40, 40, true,
						CosmosConstants.RADONITE));
				break;
			case 'n':
				this.levelTextureObjects
					.add(new BlockAnim(
						...
						"Uranium-get1.png;Uranium-get2.png;Uranium-get3.png;Uranium-get4.png;Uranium-get5.png;Uranium-get6.png",
						"Uranium1.png;Uranium2.png;Uranium3.png;Uranium4.png",
						x_pos, y_pos, 40, 40, 40, true, CosmosConstants.NEUTRON));
				break;
			case 'N':
				this.levelTextureObjects
					.add(new BlockAnim(
						game,
						"nitrogen_sprites",
						"constant/gasgreen1.png;gas-break7.png;gas-break6.png;gas-break5.png;gas-break4.png;gas-break3.png;gas-break2.png;gas-break1.png",
						"dirt-get-green1.png;dirt-get-green2.png;dirt-get-green3.png;dirt-get-green4.png;dirt-get-green5.png;dirt-get-green6.png",
						"gasgreen1.png;gasgreen2.png;gasgreen3.png;gasgreen4.png;gasgreen5.png;gasgreen6.png",
						x_pos, y_pos, 40, 40, 40, true,
						CosmosConstants.NITROGEN));
				break;
			case 'A':
				this.levelTextureObjects
					.add(new BlockEntity(
						game,
						"mn_sprites",
						"redcrystal.png;redcrystal-break7.png;redcrystal-break6.png;redcrystal-break5.png;redcrystal-break4.png;redcrystal-break3.png;redcrystal-break2.png;redcrystal-break1.png",
						"redcrystal-get1.png;redcrystal-get2.png;redcrystal-get3.png;redcrystal-get4.png;redcrystal-get5.png;redcrystal-get6.png",
						x_pos, y_pos, 40, 40, CosmosConstants.MANGANESE, 40,
						true));
				break;
			case 's':
				this.levelTextureObjects
					.add(new BlockAnim(
						game,
						"sulfur_sprites",
						"constant/gasred1.png;gas-breakred7.png;gas-breakred6.png;gas-breakred5.png;gas-breakred4.png;gas-breakred3.png;gas-breakred2.png;gas-breakred1.png",
						"dirt-get-redgas1.png;dirt-get-redgas2.png;dirt-get-redgas3.png;dirt-get-redgas4.png;dirt-get-redgas5.png;dirt-get-redgas6.png",
						"gasred1.png;gasred2.png;gasred3.png;gasred4.png;gasred5.png;gasred6.png",
						x_pos, y_pos, 40, 40, 40, true, CosmosConstants.SULFUR));
				break;
			case 'M':
				this.levelTextureObjects
					.add(new BlockEntity(
						game,
						"mg_sprites",
						"bluecrystal.png;bluecrystal-break7.png;bluecrystal-break6.png;bluecrystal-break5.png;bluecrystal-break4.png;bluecrystal-break3.png;bluecrystal-break2.png;bluecrystal-break1.png",
						"bluecrystal-get1.png;bluecrystal-get2.png;bluecrystal-get3.png;bluecrystal-get4.png;bluecrystal-get5.png;bluecrystal-get6.png",
						x_pos, y_pos, 40, 40, CosmosConstants.MAGNESIUM, 40,
						true));
				break;
			case 'g':
				this.levelTextureObjects
					.add(new GasBlockEntity(
						game,
						"gas_sprites",
						"constant/gasblue1.png;gas-breakblue7.png;gas-breakblue6.png;gas-breakblue5.png;gas-breakblue4.png;gas-breakblue3.png;gas-breakblue2.png;gas-breakblue1.png",
						"dirt-get-bluegas1.png;dirt-get-bluegas2.png;dirt-get-bluegas3.png;dirt-get-bluegas4.png;dirt-get-bluegas5.png;dirt-get-bluegas6.png",
						"gasblue1.png;gasblue2.png;gasblue3.png;gasblue4.png;gasblue5.png;gasblue6.png;",
						x_pos, y_pos, 40, 40, 40, true));
				break;
			case 'R':
				this.levelTextureObjects
					.add(new BlockEntity(
						game,
						"cr_sprites",
						"orangecrystal.png;orangecrystal-break7.png;orangecrystal-break6.png;orangecrystal-break5.png;orangecrystal-break4.png;orangecrystal-break3.png;orangecrystal-break2.png;orangecrystal-break1.png",
						"orangecrystal-get1.png;orangecrystal-get2.png;orangecrystal-get3.png;orangecrystal-get4.png;orangecrystal-get5.png;orangecrystal-get6.png",
						x_pos, y_pos, 40, 40, CosmosConstants.CHROMIUM, 40,
						true));
				break;
			case 'X':
				this.levelTextureObjects.add(new WallEntity(game, null, null,
					null, x_pos, y_pos, 40, 40, -1));
				break;
			case 'S':
				...
				break;
			case 'e':
				levelEnemyObjects.add(new EnemyEntity(game, null, null, null,
					x_pos, y_pos, 40, 40, -1));
				break;
		}
	...
	private void loadBlock(String param, int x_pos, int y_pos) {
		...
		if (CosmosConstants.debug) System.out.println(param);
		...
		if (obj.equals("msg")) {
			// Load Message Entity
			levelTextureObjects.add(new MessageEntity(game, null, null, null,
				x_pos - 40, y_pos, 40, 40, Long.parseLong(components[2]),
				components[1]));
		} else if (obj.equals("tw")) {
			// Load timed wall
			// component[1] - Interval
			// component[2] - Orientation
			levelTextureObjects.add(new TimedWallEntity(game, null, null, null,
				x_pos, y_pos, Long.parseLong(components[1]), Integer
					.parseInt(components[2])));
		} else if (obj.equals("tz")) {
			levelInteractiveObjects.add(new EventTriggerZoneEntity(game, x_pos,
				y_pos, Integer.parseInt(components[1]), Integer
					.parseInt(components[2]), components[3], components[4]));
		} else if (obj.equals("gt")) {
			Item item = null;
			if (components[1].equals("d")) item = CosmosConstants.DIRT_BLOCK;
			else if (components[1].equals("w")) item = CosmosConstants.WATER;
			else if (components[1].equals("hcl")) item = CosmosConstants.HYDROCHLORIC_ACID;
			else if (components[1].equals("hper")) item = CosmosConstants.HYDROGEN_PEROXIDE;
			else if (components[1].equals("hydroxide")) item = CosmosConstants.HYDROXIDE;
			else if (components[1].equals("co2")) item = CosmosConstants.CARBON_DIOXIDE;
			else if (components[1].equals("carbo")) item = CosmosConstants.CARBONIC_ACID;
			else if (components[1].equals("cyanide")) item = CosmosConstants.CYANIDE;
			else if (components[1].equals("hcyanide")) item = CosmosConstants.HYDROCYANIC_ACID;
			else if (components[1].equals("sulfate")) item = CosmosConstants.SULFATE;
			else if (components[1].equals("hsulfate")) item = CosmosConstants.SULFURIC_ACID;
			else if (components[1].equals("nitrous")) item = CosmosConstants.NITROUS_ACID;
			else if (components[1].equals("chromate")) item = CosmosConstants.CHROMATE;
			else if (components[1].equals("dichromate")) item = CosmosConstants.DICHROMATE;
			else if (components[1].equals("mgo")) item = CosmosConstants.MAGNESIUM_OXIDE;
			else if (components[1].equals("perchlorate")) item = CosmosConstants.PERCHLORATE;
			else if (components[1].equals("permanganate")) item = CosmosConstants.PERMANGANATE;
			...
			this.levelTextureObjects
				.add(new GateEntity(
					...
					"dirt-break1.png;dirt-break8.png;dirt-break7.png;dirt-break6.png;dirt-break5.png;dirt-break4.png;dirt-break3.png;dirt-break2.png",
					"dirt-get1.png;dirt-get2.png;dirt-get3.png;dirt-get4.png;dirt-get5.png;dirt-get6.png",
					x_pos, y_pos, Integer.parseInt(components[3]), Integer
						.parseInt(components[4]), item, Integer
						.parseInt(components[2]), components[5], 40));
		}
		...
		if (obj.equals("jumper")) {
			// Load JumperEntity
			levelInteractiveObjects.add(new JumperEntity(game,
				"jumper_sprites", "jumper.png", null, x_pos, y_pos, 40, 40, -1,
				Integer.parseInt(components[1]), Integer
					.parseInt(components[2])));
		} else if (obj.equals("dp")) {
			// Load a Power-Up
			levelInteractiveObjects.add(new DrillUpEntity(game, null,
				"blade.png", null, x_pos, y_pos, 40, 40, -1, Integer
					.parseInt(components[1])));
		} else if (obj.equals("hp")) {
			// Load a Power-Up
			levelInteractiveObjects
				.add(new HealthUpEntity(game, null, null, null, x_pos, y_pos,
					40, 40, -1, Integer.parseInt(components[1])));
		} else if (obj.equals("terminal")) {
			// Load terminal
			this.levelInteractiveObjects.add(new TerminalEntity(game, null,
				"tunnel.png", null, x_pos, y_pos, components[1]));
		}
		...
		if (obj.equals("sk")) {
			...
			this.levelEnemyObjects.add(new SpikeEnemyEntity(game,
				"spiked_enemy_sprites", "bot1.png;bot2.png", x_pos, y_pos, 100,
				direction, Integer.parseInt(components[2]), Integer
	...
	public synchronized void draw(final Graphics g) {
		...
		if (background != null) background.draw(g, background_x, background_y);
		Point playerPoint = new Point((int) game.player.getBounds().x,
			(int) game.player.getBounds().y);
		...
		try {
			...
			for (CosmosEntity obj : list) {
				if (playerPoint.distance(new Point((int) obj.getBounds().x,
					(int) obj.getBounds().y)) < CosmosConstants.WIDTH - 100
						&& obj.isAlive()) obj.draw(g);
			}
	 ...
	 * 
	 * @param source
	 *            - Target which is causing level to act
	 */
